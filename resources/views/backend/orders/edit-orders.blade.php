                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="mb-3 col-md-12">
                                        ...
                                        <input type="text" class="form-control" value="{{ $orders->invoice_number }}"
                                    ...
                                    <div class="mb-3 col-md-12">
                                        ...
                                        <input type="number" class="form-control" value="{{ $orders->charge }}"
                                    ...
                                    <div class="mb-3 col-md-12">
                                        ...
                                        <select name="courier_name" class="form-control" id="courier_name">
                                            ...
                                            <option value="steadfast" @if ($orders->courier_name == 'steadfast') selected @endif>
                                                Steadfast</>
                                            <option value="pathao" @if ($orders->courier_name == 'pathao') selected @endif>Pathao
                                                </>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="card card-primary card-outline mb-4">
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <input type="text" name="size" class="form-control"
                                                    value="{{ $details->size }}">
                                                <input type="button" value="update" onclick="submitForm({{$details->id}})"
                                ...
                                <div>
                                    ...
                                    <input type="number" class="form-control" value="{{ $orders->price }}"
...
@push('script')
    <script>
        function submitForm(id){
            ...
            fetch('/admin/orders-details/update/'+id,{
              method: 'post',
              body: formData

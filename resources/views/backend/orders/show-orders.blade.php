                                ...
                                <tbody>
                                    @foreach ($orders as $order)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{url('/admin/orders/status/'.$order->id)}}" method="post"
                                                    ...
                                                    <select name="status" class="form-control"
                                                        onchange="statusFormSubmission({{$order->id}})" style="width:auto;">
                                            ...
                                            <td>
                                                <a href="{{url('/admin/orders/edit/'.$order->id)}}" class="btn mb-1 btn-primary">Details</a>
                                                <a href="{{url('/admin/orders/delete/'.$order->id)}}" onclick="return confirm('Are you sure?')"
